...
public class ScheduleCanvas extends View {
    private Bitmap bmp, bmpSea;
    private Paint pText, pLine;

    public ScheduleCanvas(Context context) {
        super(context);
        pText = new Paint();
        pLine = new Paint();
    }

    public ScheduleCanvas(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScheduleCanvas(Context context, AttributeSet attrs, int defStyleAttr) {
